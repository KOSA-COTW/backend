...
public class PostListResponseDto {
    ...
    // 금액 관련
    private final long  amount;        // 목표 금액
    private final long  currentAmount;        // 현재 모금액
    private final long  remaining;     // 남은 금액(음수면 0)
    private final long  overfunded;    // 초과 모금액(<=0이면 0)
